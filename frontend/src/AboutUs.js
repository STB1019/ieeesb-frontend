  ...
  return (
    <div id="page">
      ...
      <p className="text-justify">
        <strong>IEEE Student Branch of Brescia</strong> is the reference for the{" "}
        <em>IEEE </em>
        (Institute of Electrical and Electronics Engineers) in Brescia. Our{" "}
        <strong>main goal</strong> is to integrate the modus operandi of
      ...
      <p className="text-justify">
        The <strong>Branch</strong> offers the opportunity to <em>research</em>{" "}
      ...
      <p className="text-justify">
        ...
        <strong>developing</strong> and <strong>maintaining</strong> a project
        mean, and also the ability to <strong>learn</strong> new concepts.
      </p>
      <p className="text-justify">
        In addition to the <em>projects</em>, we give our members the
      ...
      <p className="text-justify">
        Within the site there are some of the <em>projects</em> we are
